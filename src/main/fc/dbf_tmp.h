...
// General Drop parameters
const int numLoopsToDrop = 5;
int droppingPayload = 0;
bool dropping_prev_state = false;
int targetServo = 0;

// "Drop Next"
int contig_dropNext = 0;
int bombIndex = 0;

// "Drop Specific"
int contig_dropSpecific = 0;

// this array holds the indices of the servos for the bombs
int bombs[] = {0, 1, 2, 3};
// out_left, out_right, in_left, in_right
//int drop_order[] = {0, 3, 1, 2};
int drop_order[] = {0, 1, 2, 3};
// whether or not that bomb has been dropped
int beenDropped[] = {0, 0, 0, 0};

// RC Channel Indices
int RC_dropNext = 7;
int RC_dropSpecific = 6;
int RC_dropDial = 9;	// provides 1000-2000 range
int RC_reset = 10;

//int RC_radome = 8;
//int RADOME_STOPPED = 1500;
//int RADOME_MOVING = 1000;

int RC_THRESHOLD = 1800;
